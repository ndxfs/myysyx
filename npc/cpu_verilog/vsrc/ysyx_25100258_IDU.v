module ysyx_25100258_IDU(
	...
	//查找表数量，switch宽度，输出宽度
	//类型查找，R:000 I:001 S:010 B:011 U:100 J:101
	//以opcode判断类型
	ysyx_25100258_MuxKeyWithDefault #(1, 7, 3) u_MuxKey_type(
		type,
		inst[6:0],
		3'b111,
		{
	...
	ysyx_25100258_MuxKeyWithDefault #(6, 3, 17) u_MuxKey_inst_out(
		inst_out,
		type,
		17'b0,
		{
