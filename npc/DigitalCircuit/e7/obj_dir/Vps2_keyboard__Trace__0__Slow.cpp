...
VL_ATTR_COLD void Vps2_keyboard___024root__trace_full_0_sub_0(Vps2_keyboard___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullSData(oldp+1,(vlSelfRef.ps2_keyboard__DOT__buffer),10);
    bufp->fullCData(oldp+2,(vlSelfRef.ps2_keyboard__DOT__fifo[0]),8);
    bufp->fullCData(oldp+3,(vlSelfRef.ps2_keyboard__DOT__fifo[1]),8);
    bufp->fullCData(oldp+4,(vlSelfRef.ps2_keyboard__DOT__fifo[2]),8);
    bufp->fullCData(oldp+5,(vlSelfRef.ps2_keyboard__DOT__fifo[3]),8);
    bufp->fullCData(oldp+6,(vlSelfRef.ps2_keyboard__DOT__fifo[4]),8);
    bufp->fullCData(oldp+7,(vlSelfRef.ps2_keyboard__DOT__fifo[5]),8);
    bufp->fullCData(oldp+8,(vlSelfRef.ps2_keyboard__DOT__fifo[6]),8);
    bufp->fullCData(oldp+9,(vlSelfRef.ps2_keyboard__DOT__fifo[7]),8);
    bufp->fullCData(oldp+10,(vlSelfRef.ps2_keyboard__DOT__w_ptr),3);
    bufp->fullCData(oldp+11,(vlSelfRef.ps2_keyboard__DOT__r_ptr),3);
    bufp->fullCData(oldp+12,(vlSelfRef.ps2_keyboard__DOT__count),4);
    bufp->fullCData(oldp+13,(vlSelfRef.ps2_keyboard__DOT__ps2_clk_sync),3);
    bufp->fullBit(oldp+14,((IData)((4U == (6U & (IData)(vlSelfRef.ps2_keyboard__DOT__ps2_clk_sync))))));
    bufp->fullBit(oldp+15,(vlSelfRef.clk));
    bufp->fullBit(oldp+16,(vlSelfRef.clrn));
    bufp->fullBit(oldp+17,(vlSelfRef.ps2_clk));
    bufp->fullBit(oldp+18,(vlSelfRef.ps2_data));
    bufp->fullBit(oldp+19,(vlSelfRef.nextdata_n));
    bufp->fullCData(oldp+20,(vlSelfRef.data),8);
    bufp->fullBit(oldp+21,(vlSelfRef.ready));
    bufp->fullBit(oldp+22,(vlSelfRef.overflow));
}
