...
void Vysyx_25100258_cpu___024root____Vdpiexp_ysyx_25100258_cpu__DOT__u_RegisterFile__DOT__read_register_TOP(Vysyx_25100258_cpu__Syms* __restrict vlSymsp, IData/*31:0*/ reg_addr, IData/*31:0*/ &reg_num) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_25100258_cpu___024root____Vdpiexp_ysyx_25100258_cpu__DOT__u_RegisterFile__DOT__read_register_TOP\n"); );
    // Init
    // Body
    reg_num = vlSymsp->TOP.ysyx_25100258_cpu__DOT__u_RegisterFile__DOT__rf
        [(0x1fU & reg_addr)];
}
